...
test_RDD = sc.textFile("../data/yelp_val_in.csv").filter(lambda x: not x.startswith("user_id")).map(read_test)
...
# get Y
with open("task2_1output.csv") as in_file:
    res2_1 = in_file.readlines()[1:]
with open("task2_2output.csv") as in_file:
