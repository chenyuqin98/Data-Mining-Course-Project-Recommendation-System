...
if __name__ == "__main__":
    ...
    if 5 == 5:
        ...
        # print('cluster_pair: ', cluster_pair[0])
    ...
    if RS:
        ...
        # cluster pair: (cluster id: index of point)
        print('cluster_pair = tuple(zip(k_means.labels_, RS)) ',k_means)
    ...
    for _ in range(0, 4):
        ...
        if 8 == 8:
            ...
            for i in range(len(chunk_data)):
                ...
                # print(m_distance, 2 * (len(point) ** (1/2)))
                ...
                if m_distance < 2 * (len(point) ** (1/2)):
                    ...
                    DS_index.add(i)
            print('step', _, 'data assigned to DS', len(DS_index))
